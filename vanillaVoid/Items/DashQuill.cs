        ...
        public override ItemDisplayRuleDict CreateItemDisplayRules()
        {
            ...
            rules.Add("mdlSeeker", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmL",
                    localPos = new Vector3(0.00084F, 0.16911F, -0.02481F),
                    localAngles = new Vector3(30.8036F, 310.2001F, 142.9483F),
                    localScale = new Vector3(0.095F, 0.1F, 0.095F)
                }
            });
            rules.Add("mdlChef", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmL",
                    localPos = new Vector3(-0.03568F, 0.01603F, -0.03245F),
                    localAngles = new Vector3(318.8269F, 20.4297F, 333.1788F),
            ...
            rules.Add("mdlFalseSon", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmL",
                    localPos = new Vector3(0.02229F, 0.21898F, -0.11648F),
                    localAngles = new Vector3(22.06453F, 286.0929F, 91.11455F),
            ...
            rules.Add("mdlChirr", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "Chest",
                    localPos = new Vector3(0.15022F, 0.67692F, 0.52811F),
                    localAngles = new Vector3(45.76285F, 302.9177F, 282.2984F),
                    localScale = new Vector3(0.1F, 0.1F, 0.1F)
                },
                new RoR2.ItemDisplayRule
                {
                    ...
                    childName = "Chest",
                    localPos = new Vector3(-0.15022F, 0.67692F, 0.52811F),
                    localAngles = new Vector3(52.0629F, 268.6038F, 280.9846F),
                    localScale = new Vector3(0.1F, 0.1F, 0.1F)
                }
            });
            ...
            rules.Add("RA2ChronoBody", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmR",
                    localPos = new Vector3(0.02499F, -0.02444F, 0.24721F),
                    localAngles = new Vector3(331.6572F, 241.5781F, 289.8795F),
                    localScale = new Vector3(0.1F, 0.1F, 0.071F)
                },
                new RoR2.ItemDisplayRule
                {
                    ruleType = ItemDisplayRuleType.ParentedPrefab,
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmR",
                    localPos = new Vector3(-0.03707F, -0.02372F, 0.2144F),
                    localAngles = new Vector3(331.6572F, 241.5781F, 271.2023F),
                    localScale = new Vector3(0.1F, 0.1F, 0.071F)
                }
            });
            rules.Add("RobRavagerBody", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmL",
                    localPos = new Vector3(0.1067F, 0.08422F, 0.03253F),
                    localAngles = new Vector3(32.2339F, 187.5955F, 132.3404F),
                    localScale = new Vector3(0.075F, 0.075F, 0.075F)
                },
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmL",
                    localPos = new Vector3(0.11591F, 0.10383F, 0.0081F),
                    localAngles = new Vector3(0.20942F, 177.2035F, 112.1289F),
                    localScale = new Vector3(0.075F, 0.075F, 0.075F)
                },
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "UpperArmL",
                    localPos = new Vector3(0.13463F, 0.14561F, -0.02595F),
                    localAngles = new Vector3(359.8448F, 187.5283F, 92.01933F),
                    localScale = new Vector3(0.075F, 0.075F, 0.075F)
                }
            });
            rules.Add("mdlMorris", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "Hat",
                    localPos = new Vector3(0.1638F, 0.06368F, -0.14623F),
                    localAngles = new Vector3(314.6373F, 175.7672F, 13.29679F),
                    localScale = new Vector3(0.07F, 0.07F, 0.07F)
                }
            });
