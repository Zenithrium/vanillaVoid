...
namespace vanillaVoid.Items
{
    public class LensOrrery : ItemBase<LensOrrery>
    {
        ...
        public override GameObject ItemModel => vanillaVoidPlugin.MainAssets.LoadAsset<GameObject>("mdlOrreryPickupFinal.prefab");
        ...
        public override void Init(ConfigFile config)
        {
            ...
            "Looking through her schematics and trinkets I found something odd; something unlike what I was anticipating. A simple orrery, clearly her design, with her classic red replaced by a peculiar purple. I suppose it is only natural to tire of something after long enough... as this piece has little grounds in her previous work. At first I worried that when she learned of our arrival, when she left in a rush, that we had ruined some of her masterpieces...but maybe it's best we interrupted her. " +
            ...
            else
            {
                ...
                tempLore = $"<style=cSub>Order: Lens-Maker's Orrery \nTracking Number: ******** \nEstimated Delivery: 1/13/2072 \nShipping Method: High Priority/Fragile/Confidiential \nShipping Address: [REDACTED] \nShipping Details: \n\n</style>" +
            "The Lens-Maker, as mysterious as they are influential. From my research I have surmised that she has been appointed to \"Final Verdict\" - the most prestigious role of leadership in the House Beyond. Our team managed to locate a workshop of hers where she was supposedly working on some never-before concieved tech - but something was off. " +
            "Looking through her schematics and trinkets I found something odd; something unlike what I was anticipating. A simple orrery, clearly her design, with her classic red replaced by a peculiar purple. At first I worried that when she learned of our arrival, when she left in a rush, that we had ruined some of her masterpieces...but maybe it's best we interrupted her. " +
            "\n\nGiven that this is one of a kind, and quite a special work of hers at that, I expect much more than just currency in payment.";
        ...
        public override ItemDisplayRuleDict CreateItemDisplayRules()
        {
            ...
            rules.Add("mdlSeeker", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "LowerArmR",
                    localPos = new Vector3(-0.00471F, 0.22213F, 0.07942F),
                    localAngles = new Vector3(85.33129F, 356.3102F, 359.245F),
                    localScale = new Vector3(2.25F, 2.25F, 2.25F)
                },
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "LowerArmL",
                    localPos = new Vector3(-0.00016F, 0.22212F, -0.07933F),
                    localAngles = new Vector3(274.6687F, 356.3102F, 9.79711F),
                    localScale = new Vector3(2.15F, 2.15F, 2.15F)
                }
            });
            rules.Add("mdlChef", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "Cleaver",
                    localPos = new Vector3(-0.00492F, 0.50069F, 0.00001F),
                    localAngles = new Vector3(0F, 0F, 86.91245F),
                ...
                new RoR2.ItemDisplayRule
                {
                    ...
                    localPos = new Vector3(-0.15502F, 0.40595F, -0.00051F),
                    localAngles = new Vector3(359.1721F, 359.1821F, 89.33355F),
            ...
            rules.Add("mdlFalseSon", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "Chest",
                    localPos = new Vector3(-0.39755F, 0.26368F, 0.21003F),
                    localAngles = new Vector3(64.63329F, 349.0132F, 12.14522F),
            ...
            rules.Add("mdlNemMerc", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "Shotgun",
                    localPos = new Vector3(0.0008841306f, -0.2830543f, -0.6671141f),
                    localAngles = new Vector3(296.717f, 165.2098f, 192.2701f),
                    localScale = new Vector3(2.1f, 2.1f, 2.1f)
                }
            });
            ...
            rules.Add("RA2ChronoBody", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    localPos = new Vector3(0F, 1.62885F, 0.1819F),
                    localAngles = new Vector3(89.24307F, 0F, 0F),
            ...
            rules.Add("RobRavagerBody", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "Sword",
                    localPos = new Vector3(0.00001F, 0.33854F, -0.00702F),
                    localAngles = new Vector3(351.8321F, 0F, 0F),
                    localScale = new Vector3(2F, 2F, 2F)
                }
            });
            rules.Add("mdlMorris", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab,
                    childName = "Head",
                    localPos = new Vector3(-0.18854F, 0.11109F, 0F),
                    localAngles = new Vector3(0F, 0F, 75.50053F),
                    localScale = new Vector3(2.25F, 2.25F, 2.25F)
                }
            });
