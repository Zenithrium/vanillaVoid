...
using HarmonyLib;
using static zenithDesigns.zenithDesignsPlugin;
using On.RoR2.Items;
using VoidItemAPI;

namespace zenithDesigns.Items
{
    public class AbyssalAdze : ItemBase<AbyssalAdze>
    {
        ...
        public override GameObject ItemModel => zenithDesignsPlugin.MainAssets.LoadAsset<GameObject>("mdlAdzePickup.prefab");

        public override Sprite ItemIcon => zenithDesignsPlugin.MainAssets.LoadAsset<Sprite>("adzeIcon512.png");
        ...
        public override void Init(ConfigFile config)
        {
            ...
            CreateLang();
            CreateItem();
            ItemDef.requiredExpansion = zenithDesignsPlugin.sotvDLC;
        ...
        public override ItemDisplayRuleDict CreateItemDisplayRules()
        {
            ...
            ItemBodyModelPrefab = zenithDesignsPlugin.MainAssets.LoadAsset<GameObject>("mdlAdzeDisplay.prefab");
